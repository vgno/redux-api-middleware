...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log('isRSAA: ', _src.isRSAA((_isRSAA = {}, _isRSAA[_src.CALL_API] = {
	  endpoint: '',
	  method: 'GET',
	  types: ['REQUEST', 'SUCCESS', 'FAILURE'],
	  body: {},
	  headers: {},
	  schema: new _normalizr.Schema('key'),
	  bailout: false
	}, _isRSAA)));

	console.log('isSchema: ', new _normalizr.Schema('key') instanceof _normalizr.Schema);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EntitySchema = __webpack_require__(3);

	var _EntitySchema2 = _interopRequireDefault(_EntitySchema);

	var _ArraySchema = __webpack_require__(4);

	var _ArraySchema2 = _interopRequireDefault(_ArraySchema);

	var _lodashLangIsObject = __webpack_require__(5);

	var _lodashLangIsObject2 = _interopRequireDefault(_lodashLangIsObject);

	var _lodashLangIsEqual = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Symbol = __webpack_require__(93)['default'];

	var _Object$keys = __webpack_require__(98)['default'];

	var _interopRequireDefault = __webpack_require__(102)['default'];
	...
	function callApi(endpoint, method, headers, body, schema) {
	  ...
	  return _isomorphicFetch2['default'](endpoint, requestOptions).then(function (response) {
	    if (response.status >= 200 && response.status < 300) {
	      ...
	      return _Promise.reject(new Error(response.status + ' - ' + response.statusText));
	    }
	  }).then(function (response) {
	    return response.json();
	  }).then(function (json) {
	    if (schema) {
	      return _Promise.resolve(_normalizr.normalize(json, schema));
	    } else {
	...
	function isRSAA(action) {
	  ...
	  return _Object$keys(action).every(function (key) {
	    return ~validRootKeys.indexOf(key);
	  }) && _lodashIsplainobject2['default'](callAPI) && _Object$keys(callAPI).every(function (key) {
	    return ~validCallAPIKeys.indexOf(key);
	  }) && (typeof endpoint === 'string' || typeof endpoint === 'function') && ~['GET', 'POST', 'PUT', 'DELETE'].indexOf(method.toUpperCase()) && (Array.isArray(types) && types.length === 3) && (typeof body === 'undefined' || _lodashIsplainobject2['default'](body)) && (typeof headers === 'undefined' || _lodashIsplainobject2['default'](headers)) && (typeof schema === 'undefined' || schema instanceof _normalizr.Schema) && (typeof bailout === 'undefined' || typeof bailout === 'boolean' || typeof bailout === 'function');
	}
	  ...
	  return function (next) {
	    return function (action) {
	      ...
	      if (typeof bailout === 'boolean' && bailout || typeof bailout === 'function' && bailout(getState())) {
	        return _Promise.resolve('Bailing out');
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE){
	  __webpack_require__(63)(Constructor, NAME, next);
	  ...
	  // Fix native
	  if(_native){
	    var IteratorPrototype = __webpack_require__(44).getProto(_default.call(new Base));
	  ...
	  if(DEFAULT){
	    ...
	    } else $def($def.P + $def.F * __webpack_require__(65), NAME, methods);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(64)(P, PROMISE);
	species(P);
	species(Wrapper = __webpack_require__(37)[PROMISE]);
	...
	$def($def.S + $def.F * !(useNative && __webpack_require__(92)(function(iter){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(C){
	  if(__webpack_require__(56) && !(SPECIES in C))$.setDesc(C, SPECIES, {
	    configurable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $redef = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $              = __webpack_require__(44)
	  , global         = __webpack_require__(36)
	  , has            = __webpack_require__(58)
	  , SUPPORT_DESC   = __webpack_require__(56)
	  , $def           = __webpack_require__(35)
	  , $redef         = __webpack_require__(53)
	  , shared         = __webpack_require__(60)
	  , setTag         = __webpack_require__(64)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(KEY, exec){
	  var $def = __webpack_require__(35)
	    , fn   = (__webpack_require__(37).Object || {})[KEY] || Object[KEY]
	    , exp  = {};
	  exp[KEY] = exec(fn);
